...
import { changePassword, getUserProfile, uploadUserAvatar, userProfileUpdate } from "../services/profileService";
...
export function useUploadAvatar() {
    ...
    return useMutation({
        ...
        mutationFn: ({ data }: { data: FormData }) => uploadUserAvatar(data),
        onSuccess: (res) => {
            queryClient.invalidateQueries({ queryKey: ["profile"] });
