      ...
      <div className="flex justify-center items-center">
        <div className="max-w-3xl bg-white rounded-2xl shadow-lg border border-gray-200 p-8 text-center">
          ...
          <p className="text-gray-700 text-base leading-relaxed mb-2">
            ...
            core features. All main functionality is operational and ready to
            use.
          </p>

          <p className="text-gray-600 text-sm mb-4">
            Additional features and improvements are currently under
            development. Please allow some time as we continue to enhance your
            experience.
          </p>
