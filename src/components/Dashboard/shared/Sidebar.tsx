...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "flex h-screen w-64 flex-col bg-white border-r border-gray-200 z-50 transition-transform duration-300 ease-in-out",
      ...
      >
        ...
        <button
          onClick={closeSidebar}
          className="lg:hidden absolute top-4 right-4 p-2 rounded-md hover:bg-gray-100 transition-colors z-10"
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-2 md:space-y-3">
          ...
          <Button
            type="button"
            variant="ghost"
            className="w-full justify-start gap-3 min-h-[44px] h-auto px-4 cursor-pointer rounded-lg font-medium text-[#e5102e] hover:bg-[#feecee] hover:text-[#e5102e] active:bg-[#feecee] transition-all duration-200 touch-manipulation"
